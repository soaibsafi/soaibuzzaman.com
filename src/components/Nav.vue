<template>
  <header class="bg-gray-900 sm:flex sm:justify-between sm:items-center sm:px-4 sm:py-3 ">
    ...
    <nav :class="isOpen ? 'block' : 'hidden'" class="px-2 pt-2 pb-4 sm:flex sm:p-0">
      <a href="/about" class="block px-2 py-1 text-white font-mono  text-xl rounded hover:bg-gray-800">💡About</a>
      <a href="/blog" class="mt-1 block px-2 py-1 text-white font-mono  text-xl rounded hover:bg-gray-800 sm:mt-0 sm:ml-2">🌱Blog</a>
    </nav>
  </header>
</template>
